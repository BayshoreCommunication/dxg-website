    ...
    <MaxWidthWrapper>
      <div className='container py-10'>
        ...
        <p className='pt-5'>
          ...
          prevailing law of us. Any use of the above terminology or other words
        ...
        <p className='pt-5'>
          ...
          this from DXG for your own personal use subjected to restrictions set
        ...
        <p className='pt-5'>
          ...
          by applicable laws, DXG(Digital Xpreince Group shall not be liable for
        ...
        <p className='pt-5'>
          ...
          the hyperlink compensates the absence of DXG(Digital Xpreince Group;
