      ...
      <MaxWidthWrapper>
        <div className='container py-10'>
          ...
          <p className='pt-5'>
            ...
            conditions. Do not continue to use DXG if you do not agree to take
          ...
          <p className='pt-5'>
            ...
            this from DXG for your own personal use subjected to restrictions
          ...
          <ul>
            ...
            <li>Reproduce, duplicate or copy material from DXG</li>
          ...
          <p className='pt-5'>
            ...
            reflect the views and opinions of DXG(Digital Xpreince Group,its
            ...
            permitted by applicable laws, DXG(Digital Xpreince Group shall not
          ...
          <p className='pt-5'>
            DXG(Digital Xpreince Group reserves the right to monitor all
          ...
          <p className='pt-5'>
            You hereby grant DXG(Digital Xpreince Group a non-exclusive license
          ...
          <p className='pt-5'>
            ...
            visibility of the hyperlink compensates the absence of DXG(Digital
            Xpreince Group; and (d) the link is in the context of general
          ...
          <p className='pt-5'>
            No use of DXG(Digital Xpreince Group&apos;s logo or other artwork
