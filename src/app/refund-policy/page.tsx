  ...
  return (
    <MaxWidthWrapper>
      <div className='container py-10'>
        ...
        <p className='pt-5'>
          Thank you for shopping at DXG(Digital Xperience Group).
        </p>
        <p className='pt-5'>
        ...
        <ul>
          <li>
            <p className='pt-5'>
              ...
              in this Agreement) refers to DXG(Digital Xpreince Group, Land
              O&apos; Lakes, Florida.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className='pt-5'>
              <strong>Website</strong> refers to DXG(Digital Xperience Group),
              accessible from{' '}
              <a
        ...
        <p className='pt-5'>The following Goods cannot be returned:</p>
        <ul>
          <li>
        ...
        <p className='pt-5'>Land O&apos; Lakes, Florida, United States</p>
        <p className='pt-5'>
        ...
        <h2 className='pt-5 text-2xl font-extrabold dark:text-white'>Gifts</h2>
        <p className='pt-5'>
