            ...
            <div>
              <div className='mt-2 flex lg:justify-center'>
                <p className=' text-14 leading-24 font-semibold text-white'>
                  Digital Experience Group (DXG) is a leading event management
                  company that specializes in creating unforgettable experiences
                  for their clients, so etch your event into the minds of your
                  audience.
                </p>
              </div>
            </div>
