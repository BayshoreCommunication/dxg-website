  ...
  return (
    <MaxWidthWrapper>
      <div className='container py-10'>
        <h1 className='py-2 text-center text-3xl font-bold'>Privacy Policy</h1>
        ...
        <p className='pt-5'>For the purposes of this Privacy Policy:</p>
        <ul>
          <li>
            <p className='pt-5'>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <p className='pt-5'>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to DXG(Digital
                  Xpreince Group, Land O&apos; Lakes, Florida.
                </p>
              </li>
              <li>
                <p className='pt-5'>
              ...
              <li>
                <p className='pt-5'>
                  <strong>Website</strong> refers to DXG(Digital Xpreince
                  Group), accessible from{' '}
                  <a
                    href='https://dxg-website.vercel.app/'
            ...
            <ul>
              <li>
                <p className='pt-5'>Email address</p>
              </li>
              <li>
                <p className='pt-5'>Usage Data</p>
              </li>
            </ul>
            <h4>Usage Data</h4>
            <p className='pt-5'>
            ...
            <ul>
              <li>
                ...
                <p className='pt-5'>Type: Session Cookies</p>
                <p className='pt-5'>Administered by: Us</p>
                <p className='pt-5'>
              ...
              <li>
                ...
                <p className='pt-5'>Type: Persistent Cookies</p>
                <p className='pt-5'>Administered by: Us</p>
                <p className='pt-5'>
            ...
            <p className='pt-5'>
              ...
              in this Agreement) refers to DXG(Digital Xpreince Group, Land O
              Lakes, Florida.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className='pt-5'>
              <strong>Website</strong> refers to DXG(Digital Xpreince Group),
              accessible from{' '}
              <a
                href='https://dxg-website.vercel.app/'
                rel='external nofollow noopener'
